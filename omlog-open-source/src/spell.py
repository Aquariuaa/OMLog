...
class LogParser:
    ...
    def log_to_dataframe(self, log_file, regex, headers, logformat):
        ...
        linecount = 0
        log_count_short = []
        with open(log_file, "r", encoding='gb18030', errors='ignore') as fin:
            for line in fin.readlines():
                ...
                try:
                    ...
                    linecount += 1
                    log_count_short.append(0)
                except Exception as e:
                    log_count_short.append(1)
                    print("Skip line: " + line)
        print("len(log_count_full):",len(log_count_short))
        pd.DataFrame(data=log_count_short).to_csv('./spell_log_short.csv')
        print("log_messages:",len(log_messages))
